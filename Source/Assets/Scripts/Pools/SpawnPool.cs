	...
	void Awake()
	{
        ...
        if (m_adoptChildren)
        {
            foreach (Transform child in transform)
            {
				...
				IPoolObject obj = child.GetComponent(typeof(IPoolObject)) as IPoolObject;
...
//			if(pPoolObject.rigidbody != null && !pPoolObject.rigidbody.isKinematic)
//				pPoolObject.rigidbody.velocity = Vector3.zero;
